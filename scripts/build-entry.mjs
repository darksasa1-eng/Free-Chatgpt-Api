...
function readModule(path) {
  let code = readFileSync(root + path, "utf8");
...
const shared = readModule("src/shared.js");
const handlers = readModule("src/handlers.js");
const page = readModule("src/page.js");
...
const banner = `const ENTRY_VERSION = "entry-v3";\n\n`;

const output = banner + shared + "\n\n" + handlers + "\n\n" + page + "\n\n" + core + "\n\n" + tail;

writeFileSync(root + "api/main.js", output);
console.log("generated api/main.js:", output.length, "bytes");
